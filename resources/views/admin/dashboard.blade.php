            ...
            <div class="card-body">
                ...
                {{-- <div class="position-relative mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <ul class="chart-legend clearfix">
                                <li><i class="far fa-circle" style="color: #d4c148"></i> Bisnis kontruksi dan Properti
                                </li>
                                <li><i class="far fa-circle" style="color: #ba6906"></i> Desain Permodelan dan Informasi
                                    Bangunan</li>
                                ...
                                <li><i class="far fa-circle" style="color: #2cabe6"></i> Teknik dan Bisnis Sepeda Motor
                                </li>
